...
if(isset($_POST["vacancy_id"]) && !empty($_POST["vacancy_id"])){
    ...
    // Validate name
    $input_name = trim($_POST["vacancy_name"]);
    if(empty($input_name)){
        $name_err = "Please enter a name.";
    } elseif(!filter_var(trim($_POST["vacancy_name"]), FILTER_VALIDATE_REGEXP, array("options"=>array("regexp"=>"/^[a-zA-Z'-.\s ]+$/")))){
    ...
    $input_address = trim($_POST["vacancy_desc"]);
    ...
    // Validate salary
    $input_salary = trim($_POST["vacancy_type"]);
    ...
    if(empty($name_err) && empty($address_err) && empty($salary_err)){
        ...
        $sql = "UPDATE vacancy SET vacancy_name=?, vacancy_desc=?, vacancy_type=? WHERE vacancy_id=?";
       ...
       <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <a href="allvacancy.php" class="btn btn-default">Cancel</a>
                    </form>
                </div>
            </div> 
