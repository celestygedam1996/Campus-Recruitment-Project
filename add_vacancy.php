...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($name_err) && empty($address_err) && empty($salary_err)){
        ...
        $sql = "INSERT INTO vacancy (vacancy_name, vacancy_desc, vacancy_type) VALUES (?, ?, ?)";
...
<head>
  ...
  <title> Add Vacancy | Campus Recruitment</title>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Please fill this form and submit to add vacancy record to the database.</p>
